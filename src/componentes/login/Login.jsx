    ...
    return (
        ...
        <div className='min-h-screen bg-gray-100 text-gray-900 flex justify-center'>
            <div className='max-w-6xl m-0 sm:m-20 bg-white shadow sm:rounded-lg flex justify-center flex-1'>
                    ...
                    <form onSubmit={handleSubmit} className='w-full flex-1 mt-8 text-indigo-800'>
                        ...
                        <div className='my-12 border-b text-center'>
                            ...
                            <div className='flex-1 leading-none px-2 inline-block text-sm text-gray-600 tracking-wide font-medium bg-white transform translate-y-1/2'>
                                Or sign with social login <i className='fab fa-google w-10'/> <i className='fab fa-facebook w-10-ml-2'/>
                                
                            </div>
                        </div>
                        <div className='flex flex-col items-center'>
                            <Link to='/register' className='w-full max-w-xs font-bold shadow-sm rounded-lg py-3 bg-indigo-100 text-gray-800 flex items-center justify-center transition-all duration-300 ease-in-out focus:outline-none hover:shadow focus:shadow-sm focus:shadow-outline mt-5'>
                ...
                <div className='flex-1 bg-indigo-100 text-center hidden lg:flex' style={{ backgroundImage: `url(${login})`, minHeight:'300px', objectFit: 'cover' }}>
