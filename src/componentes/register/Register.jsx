        ...
        <div className={classes.bg}>
          <Grid container justify='center' spacing={8} className={classes.gridContainer} alignItems='stretch'>
            <Grid item xs={12} style={{margin: 0,padding: 0,textAlign: "end"}}>
              <Button color={change[0]} variant='contained'onClick={() => {setChange(["primary", "secondary"])}}>
                Log in
              </Button>
              <Button color={change[1]}variant='contained'onClick={() => {setChange(["secondary", "primary"])}}>
                Register
              </Button>
            </Grid>
